...
<body class="nk-body bg-lighter npc-default has-sidebar ">
    ...
    <div class="d-flex justify-content-between align-items-center mt-4 mb-1">
        ...
        <!-- Form Upload untuk Excel -->
        <form action="tambah_siswa.php" method="POST" enctype="multipart/form-data" class="d-flex align-items-center">
            <div class="input-group input-group-sm">
            <input type="file" name="file_excel"class="form-control" accept=".xlsx" required>
                <button type="submit" class="btn btn-success" name="upload">Upload Data</button>
            </div>
        </form>
  ...
  <table id="dataTable" class="table table-striped table-bordered" style="width:100%">
    <table>
        ...
        <tbody>
            ...
            ?>
            <tr>
                <td><input type="checkbox" name="selected_ids[]" value="<?php echo $data['nisn']; ?>"></td>
                <td><img src="<?php echo !empty($data['foto_profile_siswa']) ? $data['foto_profile_siswa'] : 'profile/default_profile.png'; ?>" alt="Foto Profil Siswa" class="foto-profil"></td>
                <td><?php echo $data['nisn']; ?></td>
                <td><?php echo $data['nama_siswa']; ?></td>
                <td><?php echo $data['nama_kelas']; ?></td>
                <td><?php echo date('d M Y', strtotime($data['tgl_lahir_siswa'])); ?></td>
                <td><?php echo $data['tempat_lahir_siswa']; ?></td>
                <td><?php echo ($data['jekel_siswa'] == 'p') ? 'Perempuan' : 'Laki-laki'; ?></td>
                ...
                <td>
                    <a href="edit_siswa.php?nisn=<?php echo $data['nisn']; ?>">
                        <button type="button" class="btn btn-warning btn-sm mb-1">Edit</button>
                    </a>
                    <a href="siswa.php?nisn=<?php echo $data['nisn']; ?>&pesan=hapus" onClick="return confirm('Apakah data yang anda pilih akan dihapus?')">
