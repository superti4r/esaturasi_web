...
if (isset($_POST['kirim'])) {
    ...
    header("Location:jurusan.php?aksi=suksestambah"); }
...
<body class="nk-body bg-lighter npc-default has-sidebar ">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formData" action="tambah_jurusan.php" method="POST">
          <div class="mb-3">
            <label for="kode" class="form-label">Kode Mata Pelajaran</label>
            <input type="text" class="form-control" name="kd_jurusan" id="kode" value="<?php  echo $kd ?>" readonly>
          </div>
          <div class="mb-3">
