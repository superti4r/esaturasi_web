...
if (isset($_POST['cari'])) {
  ...
  $sql = mysqli_query($koneksi, "SELECT * FROM bab ORDER BY kd_bab ASC");
...
<tbody id="tableData">
  ...
  <tr>
    ...
    <td><?php echo $data['kd_bab']; ?></td>
    <td><?php echo $data['nama_bab']; ?></td>
    <td>
      <a href="edit.php?kd_bab=<?php echo $data['kd_bab']; ?>"><button class="btn btn-warning btn-sm"><i class="fas fa-edit fa-fw"></i></button></a>
      <a href="delete.php?kd_bab=<?php echo $data['kd_bab']; ?>&pesan=hapus" onClick="return confirm('Apakah data yang Anda pilih akan dihapus?')"><button class="btn btn-danger btn-sm"><i class="fas fa-trash fa-fw"></i> </button></a>
    </td>
  </tr>
  <?php } ?>
</tbody>
