            ...
            <div class="col-lg-8">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <?php if (!empty($data['foto_profil_guru']) && file_exists($_SERVER['DOCUMENT_ROOT'] . '/' . $data['foto_profil_guru'])): ?>
                            <img src="<?php echo $data['foto_profil_guru']; ?>" class="img-fluid rounded" alt="Gambar Profile" style="max-height: 200px;">
                        <?php else: ?>
                            <p>Tidak ada foto</p>
                        <?php endif; ?>
                    </div>
