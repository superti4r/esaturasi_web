...
if (isset($_POST['kirim'])) {
    ...
    if (mysqli_query($koneksi, $sql)) {
        header("Location: siswa.php?aksi=suksesedit");
        exit();
    } else {
...
//ngambil data tanggal lahir
$tanggal_lahir = isset($data['tgl_lahir_siswa']) ? date('Y-m-d', strtotime($data['tgl_lahir_siswa'])) : '';
...
<body class="nk-body bg-lighter npc-default has-sidebar ">
    ...
    <h3 class="text-center mt-5 mb-4" >Halaman Edit Siswa</h3>
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalFormLabel">Edit Siswa</h5>
      ...
      <form action="" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="nisn" value="<?php echo $data['nisn']; ?>" readonly>
                                                        </div>
                                                    </div>
                                                <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="date" class="form-control" name="tgl_lahir_siswa" id="tanggal_lahir" 
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="tempat_lahir"  value="<?php echo $data['tempat_lahir_siswa']; ?>" required>
                                                        </div>
                                                    </div>            
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="no_telepon_siswa" value="<?php echo $data['no_telepon_siswa']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                    <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <button type="submit" name="kirim" class="btn btn-primary mt-2">Simpan Data</button>
                                                            <button type="button" name="batal" class="btn btn-danger mt-2" onclick="window.location.href='siswa.php'">Batal</button>
                                                        </div>
                                                    </div>
