...
if (isset($_POST['kirim'])) {
    ...
    header("Location: kelas.php?aksi=suksestambah");
}
...
<body class="nk-body bg-lighter npc-default has-sidebar ">
    ...
    <h3 class="text-center mt-3 mb-3">Tambah Kelas</h3>
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="modalFormLabel">Tambah Data Kelas</h5>
        </div>
        <div class="modal-body">
            <form id="formData" action="tambah_kelas.php" method="POST">
                <div class="mb-3">
                    <label for="kode" class="form-label">Kode Kelas</label>
                    <input type="text" class="form-control" name="kd_kelas" id="kode" value="<?php echo $kd ?>" readonly>
                </div>
                <div class="mb-3">
                    <label for="nama" class="form-label">Nama Kelas</label>
                    <input type="text" class="form-control" name="nama_kelas" id="nama" required>
                </div>
                <div class="mb-3">
                    <label for="jurusan" class="form-label">Jurusan</label>
                    <select class="form-control" name="kd_jurusan" id="jurusan" required>
                ...
                <button type="button" name="batal" class="btn btn-danger" onclick="window.location.href='kelas.php'">Batal</button>
            </form>
        </div>
    </div>
</div>
